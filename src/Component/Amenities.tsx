...
const Amenities = () => {
  return (
    <section
      className="w-full flex flex-col gap-4 mt-40 overflow-hidden"
      id="Amenities"
    >
      {/** Header */}
      <motion.h2
        ...
        {AmenitiesData.map((Amenity, i) => {
          return (
            <motion.li
              ...
              key={i}
              className="w-[80%] md:w-[30%] h-[94vh] flex flex-col items-center gap-3 shadow-lg shadow-blue-400 inset-shadow-blue-200 rounded-md"
            >
              <img
                src={Amenity.image}
                alt={Amenity.name}
                className="h-[50%] w-full rounded-tr-md rounded-tl-md"
              />
              <h3 className="w-full text-xl md:text-3xl font-bold text-center">
                {Amenity.name}
              </h3>
              <p className="md:text-lg font-medium text-gray w-[90%] md:w-full md:p-4">
                {Amenity.text}
              </p>
            </motion.li>
          );
