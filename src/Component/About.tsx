  ...
  return (
    <section className='w-full mt-2 overflow-hidden' id="About">
        ...
        <section className="w-full flex flex-wrap gap-5 justify-between md:pl-2 md:pr-2 ">
            ...
            <motion.section initial={{scale:0, opacity: 0}} whileInView={{scale : 1, opacity: 1}} transition={{ease: "easeInOut", duration:2, delay: 0.4 }} className="w-full md:w-[45%] h-[70vh] md:rounded-2xl md:shadow-2xl md:shadow-blue-400 md:inset-shadow-blue-200 flex items-center justify-center mb-2">
